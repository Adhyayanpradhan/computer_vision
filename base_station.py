...
def registered():
	...
	screen5.iconbitmap(r'./assets/images/cctv_Glf_icon.ico')
...
def issued():
	...
	screen6.iconbitmap(r'./assets/images/cctv_Glf_icon.ico')
...
def fine():
	os.system(f"python send_challan.py <pushbullet-access-token> note {get_devices.get_device_api()}")
def database():
	global screen3
	screen3=Toplevel(main)
	screen3.title("GOVERNMENT DATABASE")
	screen3.geometry("500x400")
	screen3.iconbitmap(r'./assets/images/cctv_Glf_icon.ico')
	...
	Label(screen3,text="").pack()
def challan():
	os.system(f"python all_vehicle.py <pushbullet-access-token> note {get_devices.get_device_api()}")
def smart():
	global screen4
	screen4=Toplevel(main)
	screen4.title("Smart Traffic management")
	screen4.geometry("400x300")
	screen4.iconbitmap(r'./assets/images/cctv_Glf_icon.ico')
...
def speed():
	...
	screen2.iconbitmap(r'./assets/images/cctv_Glf_icon.ico')
...
def plate_detect():
	# os.chdir("./model-20191217T031955Z-001/model/models/research/object_detection")
...
main.iconbitmap(r'./assets/images/cctv_Glf_icon.ico')
