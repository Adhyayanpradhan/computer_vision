...
def graphic(res):
    ...
    master.iconbitmap(r'./assets/images/cctv_Glf_icon.ico')
...
def main_plate():
    ...
    result = []
    cap = cv2.VideoCapture("./assets/videos/test3.mp4")
    frame_id = 0
    while (cap.isOpened()):
        ret, frame = cap.read()
        frame_id += 1
    ...
    with open('./assets/data/plates.json', 'w') as json_file:
    ...
    y=[]
    res=[]
    with open('./assets/data/plates.json') as json_file:
